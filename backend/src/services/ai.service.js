...
export const generateMarketingStrategyAI = async (campaignData, userPlan = 'free') => {
  ...
  const prompt = `You are a senior marketing strategist. Write a concise video-first marketing strategy in clean markdown prose. No JSON. No bullet dumps. Short paragraphs — 3-5 sentences max per section. Be specific and direct.
...
Write EXACTLY these 6 sections using ## headers. Each section is 2-4 short punchy paragraphs. No nested lists, no JSON, no tables.

## 1. Campaign Intelligence
The single biggest insight about this market and why video wins here. What emotional angle competitors are missing.

## 2. Video Content Strategy
The hook approach, emotional arc, and why a specific bracket fits. What makes this content stop the scroll.

## 3. Target Audience
Who they really are beyond demographics. Their actual language, fears, and desires. What makes them share.

## 4. Platform & Distribution
Where to post, when, and how often. One specific tactic per platform. No generic advice.

## 5. Viral Triggers
The 2-3 specific psychological or cultural elements that will make this content spread. Specific to this product and market.

## 6. 30-Day Action Plan
Week 1, Week 2, Week 3, Week 4 — one clear action each. Concrete and achievable.

Write in confident direct prose. Short sentences. No fluff. No JSON.`;
