...
// The core IVey workflow in one place â€” no tabs, no hunting
...
// â”€â”€ Script display with copy â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Platform chips â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const PLATFORMS = [
  { id: 'instagram', label: 'Instagram', emoji: 'ðŸ“¸', color: 'border-pink-500 bg-pink-500/10 text-pink-400'    },
  { id: 'tiktok',    label: 'TikTok',    emoji: 'ðŸŽµ', color: 'border-cyan-500 bg-cyan-500/10 text-cyan-400'    },
  { id: 'facebook',  label: 'Facebook',  emoji: 'ðŸ“˜', color: 'border-blue-500 bg-blue-500/10 text-blue-400'    },
  { id: 'linkedin',  label: 'LinkedIn',  emoji: 'ðŸ’¼', color: 'border-indigo-500 bg-indigo-500/10 text-indigo-400' },
  { id: 'youtube',   label: 'YouTube',   emoji: 'â–¶ï¸', color: 'border-red-500 bg-red-500/10 text-red-400'       },
];
...
const StudioPage = ({ embedded = false }) => {
  ...
  // â”€â”€ Fetch campaigns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Check HeyGen status â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Select campaign â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Generate script â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const STAGES = [
    'ðŸ§  Excavating audience psychology...',
    'ðŸ” Analysing competitive landscape...',
    'ðŸŽ­ Designing narrative arc...',
    'ðŸŽ£ Running Hook Laboratory...',
    'âœï¸  Writing production script...',
    'ðŸ“Š Scoring for viral potential...',
  ];
  ...
  const handleGenerateScript = async () => {
    ...
    try {
      ...
      // Stay on step 2 â€” user reviews script then clicks Next
    } catch (err) { setError(err.message); }
    finally { clearInterval(ticker); setGeneratingScript(false); setScriptStage(''); }
  };

  // â”€â”€ Produce video â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const handleProduce = async () => {
    ...
    try {
      ...
      showToast('ðŸŽ¬ Video generation started â€” takes 5-10 minutes', 'info');
  ...
  const pollVideoStatus = async (vid) => {
    try {
      ...
      if (data.status === 'completed') {
        ...
        setStep(4);
        showToast('ðŸŽ¬ Video ready! Distribute it now.', 'success');
      }
  ...
  const handleImportManualUrl = () => {
    ...
    setManualUrl('');
    setStep(4);
    showToast('âœ… Video URL imported', 'success');
  };

  // â”€â”€ Copy script â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const handleCopy = () => {
    ...
    <div className={embedded ? '' : 'min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 py-10 px-4'}>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Script â†’ Produce â†’ Distribute â€” all in one place</p>
        </div>
        ...
        {error && (
          <div className="px-4 py-3 bg-red-900/20 border border-red-800 text-red-400 rounded-xl text-sm flex items-center gap-2">
            ...
            <button onClick={() => setError('')} className="ml-auto text-red-400 hover:text-red-300">âœ•</button>
          </div>
        )}

        {/* â”€â”€ STEP 1: Campaign picker â”€â”€ */}
                ...
                <div className="space-y-2 max-h-72 overflow-y-auto pr-1">
                  {campaigns.map(c => (
                    <button key={c.id} onClick={() => handleSelectCampaign(c)}
                      ...
                      <div className="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center text-sm flex-shrink-0">ðŸŽ¯</div>
                ...
                <div>
                  ...
                  {script && step > 2 && (
                    <p className="text-xs text-gray-500 mt-0.5">
                      {fmtDur(seconds)} Â· Score {viralScore}/100
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="p-5 space-y-4">
              ...
              {winnerHook && !generatingScript && (
                <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                  <p className="text-xs font-bold text-amber-400 mb-1">Opening Hook â€” {winnerHook.formula}</p>
              ...
              <div className="flex gap-2 flex-col sm:flex-row">
                {script && step === 2 && (
                  <button onClick={() => setStep(3)}
                    ...
                    <span>ðŸŽ¬</span><span>Next â€” Produce Video</span>
                  </button>
                )}
                <button onClick={handleGenerateScript} disabled={generatingScript}
                  ...
                  {generatingScript
                    ...
                    : <><span>âš¡</span><span>{script ? 'Regenerate' : 'Generate Script'}</span></>
                  }
                </button>
              </div>
            </div>
        ...
        {/* â”€â”€ STEP 3: Produce â”€â”€ */}
        {step >= 3 && (
          <PlanGate
            requiredPlan="creator"
            feature="Video Production"
            description="Upgrade to Creator to automatically produce HeyGen videos from your scripts â€” 5 videos/month included."
          >
          <div className={`bg-white dark:bg-gray-800 border rounded-2xl overflow-hidden transition-all ${
            ...
            <div className="p-5 space-y-4">
              ...
              {videoStatus === 'processing' && (
                <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">You can leave this page â€” we'll have it ready when you return.</p>
                  </div>
                </div>
              )}
              ...
              {heygenConfigured === false && (
                <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                  <p className="text-sm font-bold text-amber-400 mb-2">âš¡ HeyGen not connected</p>
                          ...
                          {avatars.slice(0, 12).map(av => (
                            <button key={av.avatar_id} onClick={() => setAvatarId(av.avatar_id)}
                              ...
                              {av.preview_image_url
                                ...
                                : <div className="w-10 h-10 rounded-lg bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-lg">ðŸ‘¤</div>
                              }
                        ...
                        <select value={voiceId} onChange={e => setVoiceId(e.target.value)}
                          ...
                          {voices.map(v => (
                            <option key={v.voice_id} value={v.voice_id}>
                              {v.display_name || v.name} {v.gender ? `â€” ${v.gender}` : ''} {v.accent ? `(${v.accent})` : ''}
                            </option>
                          ))}
                        </select>
                      </div>
              ...
              {heygenConfigured && videoStatus !== 'processing' && !videoUrl && (
                <button onClick={handleProduce} disabled={producing || !avatarId || !voiceId}
                  ...
                  {producing
                    ...
                    : <><span>ðŸŽ¬</span><span>Produce with HeyGen</span></>}
                </button>
              )}

              {/* Manual URL fallback â€” always available */}
        ...
        {/* â”€â”€ STEP 4: Distribute â”€â”€ */}
        {step >= 4 && (
          <PlanGate
            requiredPlan="starter"
            feature="Social Distribution"
            description="Upgrade to Starter to distribute videos to TikTok, Instagram, Facebook and more â€” 20 posts/month included."
          >
        ...
        {step > 1 && (
          <button onClick={() => {
            ...
            â† Start over with a different campaign
          </button>
        )}
      </div>
