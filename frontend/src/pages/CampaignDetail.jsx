        ...
        <div>
          ...
          {activeTab === 'script' && script && (
            <div className="p-5 space-y-4">
              ...
              {/* HeyGen Prompt — shown when available */}
              {intel?.heygenPrompt && (
              ...
              {/* Primary action — copy + open HeyGen in one click */}
...
const parseStrategy = (strategy) => {
  ...
  const iconMap = { 'intelligence':'🎯','video':'🎬','audience':'👥','platform':'📢','distribution':'📢','viral':'⚡','metric':'📊','action':'📅','competitive':'🔍','brand':'🎨','content':'📝','pillar':'📐' };
