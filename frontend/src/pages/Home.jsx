    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors pt-20">
      ...
      <div className="px-6 lg:px-12 py-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Column - Content */}
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-sm mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link 
                to="/demo"
                className="px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-semibold text-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors text-center"
              >
                Watch Demo
              </Link>
            </div>
            ...
            <div className="flex items-center gap-8 mt-12">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900 dark:text-white">2.3M+</div>
            ...
            <div className="bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/20 dark:to-blue-900/20 rounded-2xl p-8">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white">Campaign Brief</span>
                </div>
                ...
                <div className="flex gap-2">
                  <div className="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-xs">TikTok</div>
                  <div className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs">Instagram</div>
                  <div className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-xs">Email</div>
                </div>
              </div>
      ...
      {/* Features Section */}
      <div className="px-6 lg:px-12 py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">15+ Content Formats</h3>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Multi-AI Power</h3>
              <p className="text-gray-600 dark:text-gray-400">
      ...
      <div className="px-6 lg:px-12 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              to="/pricing"
              className="px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-semibold text-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors"
            >
              View Pricing
            </Link>
          </div>
